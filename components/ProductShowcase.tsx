              ...
              <div className="p-6 bg-gray-50 h-80 flex flex-col gap-4">
                ...
                <div className="self-start max-w-[85%]">
                  <div className="bg-white p-4 rounded-2xl rounded-tl-none shadow-sm text-gray-700 text-sm">
                    Olá, gostaria de saber se o sistema emite nota fiscal automaticamente e se integra com o meu ERP.
                  </div>
                ...
                <div className="self-end max-w-[90%]">
                  <div className="bg-brand-100 p-4 rounded-2xl rounded-tr-none shadow-sm text-brand-900 text-sm">
                    Olá! Sim, o <strong>Floki</strong> emite NF-e automaticamente após a confirmação do pagamento. Além disso, possuímos integração nativa via API com a maioria dos ERPs do mercado.
                    <br/><br/>
                    Gostaria que eu te enviasse a documentação técnica?
                  </div>
